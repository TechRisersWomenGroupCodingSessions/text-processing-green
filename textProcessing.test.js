...
describe("index", () => {
	...
	it("evaluates the text and returns a list of the top 10 used words without including multiple stop words not case sensitive to ignore", () => {
		text.resetPunctuationFlag();
		const textString = `Hello, hello you today you you are are are are very very very very very hot hot hot hot hot hot hot today`;

		expect(
			text.topTenList(textString, false, ["Today", "hello"])
		).toStrictEqual(
